variable "create_ecr_repo" {
  description = "Controls whether ECR repository image should be created"
  type        = bool
  default     = false
}
...
variable "ecr_user" {
    description = "User to use for pushing to ECR"
    type      = string
    default   = null
}

variable "ecr_password" {
    description = "Password to use for pushing to ECR"
    type        = string
    default     = null
}
